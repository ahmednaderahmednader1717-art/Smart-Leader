...
const ProjectsGrid = () => {
  const projects = [
    ...
    {
      id: 4,
      title: 'Residential Complex in Maadi',
      ...
      area: '100-180 sqm',
      completion: 'Q1 2025',
      description: 'Family-friendly residential complex with green spaces and modern facilities.',
    },
    {
      id: 5,
    ...
    {
      id: 6,
      title: 'Mixed-Use Development in Nasr City',
      ...
      area: '80-150 sqm',
      completion: 'Q3 2025',
      description: 'Modern mixed-use development with residential and commercial units.',
    },
  ]
