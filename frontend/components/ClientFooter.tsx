        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services" className="text-gray-300 dark:text-gray-400 hover:text-primary-400 dark:hover:text-primary-300 transition-colors text-sm">
                  Services
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 dark:text-gray-400 text-sm">Real Estate Development</li>
              <li className="text-gray-300 dark:text-gray-400 text-sm">Property Management</li>
              <li className="text-gray-300 dark:text-gray-400 text-sm">Investment Consulting</li>
              <li className="text-gray-300 dark:text-gray-400 text-sm">Legal Services</li>
              <li className="text-gray-300 dark:text-gray-400 text-sm">Market Analysis</li>
            </ul>
          </div>
